...
import { getAllAssets, getAssetHistory, getMyAssets, getAssetById, createAsset, deleteAsset, updateAssetSpec, updateAssetStatus, transferAsset } from '../controllers/assetController'
...
router.post('/',             protect, requireRole(ROLES.ADMIN, ROLES.MANAGER), createAsset)
router.delete('/:id',        protect, requireRole(ROLES.ADMIN, ROLES.MANAGER), deleteAsset)
router.patch('/:id/spec',    protect, requireRole(ROLES.ADMIN, ROLES.MANAGER), updateAssetSpec)
